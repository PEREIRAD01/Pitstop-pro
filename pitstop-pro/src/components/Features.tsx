	...
	return (
		<section className='bg-background text-text py-16 px-6'>
			<div className='max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-8 text-center'>
				...
				<FeatureCard Icon={CurrencyEur} title='Expense Tracking - coming soon' description='Know exactly how much you vehicle is costing you on maintenance, repairs and insurance. ' />
